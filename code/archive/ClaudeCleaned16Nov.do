****************************************************
* Last Updated: 16 November 02:00 [FINAL CLEAN VERSION]
...
label define agecat_l 11 "Age group ~11" 13 "Age group ~13" 15 "Age group ~15"
...
* Joint significance test of controls (cluster-robust)
testparm 1.sex 13.agecat 15.agecat 2010.wave 2014.wave ///
         2.welloff 3.welloff 4.welloff 5.welloff
di as result "F-test (Wald): Joint significance of controls"
