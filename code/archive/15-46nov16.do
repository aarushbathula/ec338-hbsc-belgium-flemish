...
* Improve sex variable label for tables
...
local descvars acachieve_rev same_sex sex agecat welloff siblingsum
...
esttab desc_single desc_full using "$TABLES/table1_descriptives.tex", ///
    ...
    addnotes("Standard deviations in parentheses. Weighted by sample weights." ///
             ...
             "Sex: 1=Male, 2=Female. Sample: Ages 11, 13, 15; waves 2006, 2010, 2014; Belgium (Flemish).")
...
local balvars sex agecat wave welloff

* Store joint F-test result first (includes wave since main spec has wave FE)
qui reg same_sex i.sex i.agecat i.wave i.welloff [pw=weight] ///
...
esttab using "$TABLES/table2_balance.tex", ///
    ...
    addnotes("Standard deviations in parentheses. Single-sibling sample only. Weighted means." ///
             "Sex: 1=Male, 2=Female. Joint F-test of same\_sex on all covariates: F(`joint_df',`joint_dfr') = `joint_f', p = `joint_p'." ///
...
* Note: Use c.same_sex##i.welloff for fully flexible categorical interaction
